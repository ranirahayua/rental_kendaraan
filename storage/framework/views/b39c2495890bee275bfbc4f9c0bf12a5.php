                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('cabang.index')); ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('kendaraan.index')); ?>" aria-expanded="false">
                                <span>
                                    <i class="ti ti-car"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('pengguna.index')); ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('penyewaan.index')); ?>" aria-expanded=" false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('berjalan')); ?>" aria-expanded=" false">
                                <span>
                                    <i class="ti ti-receipt"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('riwayat')); ?>" aria-expanded=" false">
                                <span>
                                    <i class="ti ti-receipt"></i>
                                </span>
...
</html><?php /**PATH C:\xampp\htdocs\rental-kendaraan - Copy\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>