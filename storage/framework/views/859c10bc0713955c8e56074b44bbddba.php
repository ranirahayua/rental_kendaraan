            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <form action="<?php echo e(route('selesaikan', $data->id)); ?>" method="post">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rental-kendaraan - Copy\resources\views/admin/penyewaan/berjalan.blade.php ENDPATH**/ ?>