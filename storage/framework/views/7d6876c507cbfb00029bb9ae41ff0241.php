...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <p class="fs-4 mb-0 fw-bold">Tidak mempunyai akun?</p>
                                        <a class="text-primary fw-bold ms-2" href="<?php echo e(route('register.index')); ?>">Buat
                                            disini</a>
                                    </div>
                                </form>
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\rental-kendaraan - Copy\resources\views/auth/login.blade.php ENDPATH**/ ?>