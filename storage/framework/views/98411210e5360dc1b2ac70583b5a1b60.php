...
<div class="container mx-auto" style="padding-top: 110px;">
    <h2 class="text-center">Kendaraan Yang Tersedia</h2>
    <br>
    <div class="row">
        <?php $__empty_1 = true; $__currentLoopData = $kendaraan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="col-md-3">
            <div class="card-sl">
                <form action="<?php echo e(route('pesan.kendaraan', $data->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="card-image">
                        <img src="<?php echo e(asset('assets/images/kendaraan/'.$data->image)); ?>" />
                    </div>
                    <div class="card-heading">
                        <div class="d-flex align-items-baseline">
                            <h3><?php echo e($data->merek); ?></h3>
                            <h6>&nbsp;/ <?php echo e($data->model); ?></h6>
                        </div>
                    </div>
                    <div class="card-text">
                        <div class="d-flex align-items-center">
                            ...
                            <p class="p-0 m-0 mx-2"><?php echo e($data->cabang->nama_cabang); ?></p>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <p class="p-0 m-0 mx-2"><?php echo e($data->cabang->alamat_cabang); ?></p>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <p class="p-0 m-0 mx-2"><?php echo e($data->cabang->no_telepon_cabang); ?></p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rendal-kendaraan\resources\views/page/kendaraan.blade.php ENDPATH**/ ?>